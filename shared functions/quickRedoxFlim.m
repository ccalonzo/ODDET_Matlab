function [Redox,TauM,Int755,Int860,A1,A2,Tau1,Tau2] = quickRedoxFlim(fieldCode,power755,power860)
...
Flimage = prettyFlim(TauM,Int755);
Redox2 = prettyRedox(Redox,Int755+Int860,'none',jet(64),0.4,0);
